...
//    def scannerHome = tool 'sonar-scanner';
      sh '''
         # /home/tomcat/.jenkins/tools/hudson.plugins.sonar.SonarRunnerInstallation/sonar-scanner/bin/sonar-scanner -Dsonar.projectKey=spring-petclinic -Dsonar.projectName=spring-petclinic -Dsonar.sources=. -Dsonar.java.binaries=./src
